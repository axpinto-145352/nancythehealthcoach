          ...
          <div>
            ...
            <div className="bg-nancy-sage rounded-xl p-5 mb-6">
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <img src={`${import.meta.env.BASE_URL}amen-badge.svg`} alt="Certified Elite Brain Health Coach - Amen University" className="h-20 w-20 sm:h-24 sm:w-24 flex-shrink-0" />
