...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "I'm an Elite Brain Health Coach Certified (EBHCC) through Amen University (January 2026). My training is based on Dr. Daniel Amen's research using over 210,000 brain SPECT scans.",
    },
  ];
